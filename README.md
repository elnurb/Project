...
Hello, welcome to this lesson. Today I create with html and css file for Project. I use here html and css tags. 
## ## RULES OF USE

> *STEP-1:* `https://github.com/elnurb/Project.git` <br/>
> *STEP-2:*  enter the `Project` folder that appears <br/>
> *STEP-3:*  open the folder you are in in a text editor <br/>
> *STEP-4:*  run the  all the`index.html` files in the main folder <br/>
> *STEP-5:*  to download the project as `.zip`  [here](https://github.com/elnurb/Project/archive/refs/heads/main.zip) click <br/>
